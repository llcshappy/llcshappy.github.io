(function () {
  ...
  var STRINGS = {
    en: {
      ...
      "meta.index": "Luyang Wang — 3DV, stereo matching, semantic segmentation, Remosaic, ISP/RAW, and event-based vision",
      ...
      affil: "ISP / RAW & demosaic · Event-based vision · Embedded perception",
    ...
    zh: {
      ...
      "title.crafts": "手工 · 王路阳",
      "title.notes": "随记 · 王路阳",
      "meta.index": "王路阳 — 三维视觉、立体匹配、语义分割、Remosaic、ISP/RAW 与事件视觉",
      "meta.crafts": "王路阳 — 手工与小创作",
      "meta.notes": "王路阳 — 随记、分享与学习记录",
      "portrait.alt": "王路阳照片",
      "role.line": "三维视觉 · 立体匹配 · 语义分割 · Remosaic",
      affil: "ISP/RAW 与去马赛克 · 事件视觉 · 端侧感知",
