(function () {
  ...
  var STRINGS = {
    en: {
      ...
      "meta.index": "Luyang Wang — EVS / event-based vision, computer vision, and embedded sensing",
      ...
      bio:
        "I am an algorithm expert at <strong>Alpsentek</strong>, working on algorithms and applications built around <strong>EVS</strong> (event-based vision) for ultra-low-power sensing. Previously I was perception PL for the <strong>Xiaoyao</strong> line at <strong>Narwal</strong> (semantic segmentation, stereo depth, and end-to-end upstream/downstream integration). At <strong>SenseTime</strong> I focused on <strong>Remosaic</strong> and broader <strong>image-quality (IQ)</strong> algorithms for mobile ISP pipelines. My background is in automation from <strong>Tsinghua</strong> (M.Eng.) and <strong>HUST</strong> (B.Eng.).",
      "section.education": "Education",
      "edu.tsinghua.school": "Tsinghua University",
      "edu.tsinghua.degree": "M.Eng., Automation",
      "edu.hust.school": "Huazhong University of Science and Technology",
      "edu.hust.degree": "B.Eng., Automation",
      "section.skills": "Technical skills",
      "skills.cv.dt": "Computer vision",
      "skills.cv.dd":
        "Event-based / EVS vision, stereo matching, semantic segmentation, RAW/ISP and Remosaic-style pipelines, quantization & edge deployment.",
      "skills.lang.dt": "Languages & frameworks",
      "skills.lang.dd": "Python, C/C++, MATLAB · PyTorch, TensorFlow, ONNX Runtime, OpenMMLab ecosystem.",
      "skills.edge.dt": "Edge deployment",
      "skills.edge.dd": "Horizon X5M, Allwinner MR536 — PTQ, latency optimization, accuracy alignment.",
      "skills.tool.dt": "Tooling",
      "skills.tool.dd": "Linux, Git, Docker, SQL, Streamlit, Gradio.",
    ...
    zh: {
      ...
      "title.crafts": "手工 · 王路阳",
      "title.notes": "随记 · 王路阳",
      "meta.index": "王路阳 — 事件视觉 EVS、计算机视觉与嵌入式感知",
      ...
      bio:
        "我现任 <strong>Alpsentek</strong> 算法专家，从事基于 <strong>EVS</strong>（事件视觉）的超低功耗感知算法与应用。此前在 <strong>云鲸 Narwal</strong> 担任 <strong>逍遥</strong> 产品线感知 PL，负责<strong>语义分割</strong>、<strong>双目深度</strong>及数据、模型、部署与协同上下游。在 <strong>商汤 SenseTime</strong> 期间聚焦 <strong>Remosaic</strong> 与移动端 <strong>画质（IQ）</strong> / ISP 相关算法。本科毕业于<strong>华中科技大学</strong>（自动化），硕士毕业于<strong>清华大学</strong>（自动化）。",
      "section.education": "教育背景",
      "edu.tsinghua.school": "清华大学",
      "edu.tsinghua.degree": "工学硕士，自动化",
      "edu.hust.school": "华中科技大学",
      "edu.hust.degree": "工学学士，自动化",
      "section.skills": "专业技能",
      "skills.cv.dt": "计算机视觉",
      "skills.cv.dd":
        "事件视觉 / EVS、立体匹配、语义分割、RAW/ISP 与 Remosaic 类管线、量化与边缘部署。",
      "skills.lang.dt": "语言与框架",
      "skills.lang.dd": "Python、C/C++、MATLAB · PyTorch、TensorFlow、ONNX Runtime、OpenMMLab 等。",
      "skills.edge.dt": "边缘部署",
      "skills.edge.dd": "地平线 X5M、全志 MR536 等平台的 PTQ、时延与精度对齐。",
      "skills.tool.dt": "工具",
      "skills.tool.dd": "Linux、Git、Docker、SQL、Streamlit、Gradio。",
